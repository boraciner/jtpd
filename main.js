...
let PelcoDUpRight = new Uint8Array([0xFF,  0x01,  0x00,  0x0A,  0x30, 0x30,  0x00]);
let PelcoDUpLeft = new Uint8Array([0xFF,  0x01,  0x00,  0x0C,  0x30, 0x30,  0x00]);
let PelcoDRight = new Uint8Array([0xFF,  0x01,  0x00,  0x02,  0x30, 0x00,  0x00]);
let PelcoDLeft = new Uint8Array([0xFF,  0x01,  0x00,  0x04,  0x30, 0x00,  0x00]);
let PelcoDDown = new Uint8Array([0xFF,  0x01,  0x00,  0x10,  0x00,	0x30,  0x00]);
let PelcoDDownRight = new Uint8Array([0xFF,  0x01,  0x00,  0x12,  0x30, 0x30,  0x00]);
let PelcoDDownLeft = new Uint8Array([0xFF,  0x01,  0x00,  0x14,  0x30, 0x30,  0x00]);
